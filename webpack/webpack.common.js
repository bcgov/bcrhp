...
module.exports = () => {
    return new Promise((resolve, _reject) => {
        ...
        global.PUBLIC_SERVER_ADDRESS = parsedData['WEBPACK_SERVER_ADDRESS']
            ? parsedData['WEBPACK_SERVER_ADDRESS']
            : parsedData['PUBLIC_SERVER_ADDRESS'];
        ...
        if (fs.existsSync(projectJSONFilepath)) {
            ...
            parsedPackageJSONFilepaths[
                Path.join(projectPackageJSON.name, 'package.json').replace(
                    /\\/g,
                    '/',
                )
            ] = projectJSONFilepath;
