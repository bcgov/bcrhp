...
select distinct bn.resourceinstanceid,
                ...
                br.registration_status as registration_status,
                cn.name common_name,
                array_to_string(other_name.names, '; ') as other_name,
                prop.pid,
                prop.street_address,
                prop.city,
                prop.postal_code,
                ...
                ht.heritage_theme,
                hc.heritage_class,
                msb.area_sqm::numeric(19,2) as dimensions_area_sqm,
                msb.site_centroid_latitude::numeric(10,6) as gis_latitude,
                msb.site_centroid_longitude::numeric(10,6) as gis_longitude,
                msb.utmzone::numeric(2,0) as utm_zone,
                msb.utmnorthing::numeric(10,0) as utm_northing,
                msb.utmeasting::numeric(10,0) as utm_easting,
                'https://apps.nrs.gov.bc.ca/int/bcrhp/report/'||bn.resourceinstanceid as site_url,
                msb.site_boundary,
