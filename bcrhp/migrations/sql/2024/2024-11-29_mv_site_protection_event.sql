...
select pe.resourceinstanceid,
       ...
       reference_number,
       protection_notes,
       __arches_get_concept_label(la.authority) as authority,
       __arches_get_concept_label(la.legal_instrument) as legal_instrument,
       la.act_section->'en'->>'value' as act_section,
       __arches_get_concept_label(la.recognition_type) as recognition_type,
       gn.government_name,
       gn.government_type
