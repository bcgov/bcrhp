...
select resourceinstanceid,
       __arches_get_concept_label(construction_actor_type) as actor_type,
       array_agg(construction_actor->'en'->>'value') as actors,
       array_remove(array_agg(construction_actor_notes->'en'->>'value'),'') as notes
