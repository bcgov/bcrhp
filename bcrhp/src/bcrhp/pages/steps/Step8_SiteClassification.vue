...
<template>
    <FieldSet id="heritageDetailsFieldset">
        <p class="mb-2">Heritage Class</p>
        <LabelledInput label="Number of Contributing Resources" input-name="referenceNumber"
            :error-message="errors.referenceNumber?.join(',')" :required="true">
            <div>
                <InputText id="numberOfResources" ref="numberOfResourcesField" v-model="heritageSite.numberOfResources"
                ...
                <Button id="saveReferenceNumber" label="Add" class="inline-block"
                    @click="addContributingSource"></Button>
            </div>
        </LabelledInput>
        <div class="flex flex-col">
            ...
            <div class="card flex flex-wrap gap-4">
                <div class="flex items-center gap-2">
                    <Checkbox v-model="heritageCategory" inputId="category1" name="archaeologicalSite"
                        value="archaeologicalSite" />
                    <label for="category1"> Archaeological Site / Remains </label>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="heritageCategory" inputId="category2" name="building" value="building" />
                    <label for="category2"> Building </label>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="heritageCategory" inputId="category3" name="collection" value="collection" />
                    <label for="category3"> Collection </label>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="heritageCategory" inputId="category4" name="landscapeFeatures"
                        value="landscapeFeatures" />
                    <label for="category4"> Landscape(s) or Landscape Feature(s) </label>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="heritageCategory" inputId="category5" name="structure" value="structure" />
            ...
            <div class="card flex flex-wrap gap-4">
                <div class="flex items-center gap-2">
                    <Checkbox v-model="ownership" inputId="ownership1" name="Not-for-profit" value="notForProfit" />
                    <label for="ownership1"> Not-for-profit </label>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="ownership" inputId="ownership2" name="private" value="private" />
                    <label for="ownership2"> Private </label>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="ownership" inputId="ownership3" name="publicFederal" value="publicFederal" />
                    <label for="ownership3"> Public (federal) </label>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="ownership" inputId="ownership4" name="publicLocal" value="publicLocal" />
                    <label for="ownership4"> Public (local) </label>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="ownership" inputId="ownership5" name="publicProvincial"
    ...
    <Fieldset id="heritageFunctionFieldset" class="p-fieldset p-component mt-2">
        <p class="mb-1 mt-2">Heritage Function</p>
        <div class="flex flex-row">
            <LabelledInput label="Heritage Category" input-name="heritageTheme"
                :error-message="errors.functionCategory?.join(',')" :required="true">
                <div class="p-inputtext-fluid">
                    <InputText id="functionCategory" ref="functionCategoryField" v-model="heritageSite.functionCategory"
                        aria-describedby="function-category-help" aria-required="true" fluid @change="valueChanged"
            ...
            <div class="flex flex-col">
                <div class="card flex flex-wrap gap-4">
                    <div class="flex items-center gap-2">
                        <Checkbox v-model="functionCategoryCurrent" inputId="current" name="functionCategoryCurrent"
                            value="functionCategoryCurrent" />
                        <label for="ownership1"> Current </label>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    <Checkbox v-model="functionCategoryHistoric" inputId="historic" name="functionCategoryCHistoric"
                        value="functionCategoryCHistoric" />
                    <label for="ownership1"> Historic </label>
                </div>
            </div>
            <Button id="addOtherName" label="Add" class="inline-block" @click="saveOtherName"></Button>
        </div>
    </Fieldset>
    <Fieldset id="heritageThemeFieldset" class="p-fieldset p-component mt-2">
        <p class="mb-1 mt-2">Heritage Theme</p>
        <LabelledInput label="Heritage Theme" input-name="heritageTheme"
            :error-message="errors.heritageTheme?.join(',')" :required="true">
            <div class="p-inputtext-fluid">
                <InputText id="heritageTheme" ref="heritageThemeField" v-model="heritageSite.heritageTheme"
                    aria-describedby="heritage-theme-help" aria-required="true" fluid @change="valueChanged"
                    @focus="onFocusHandler" @focusout="onFocusOutHandler" @update:model-value="valueUpdated" />
            </div>
        </LabelledInput>
    </Fieldset>
