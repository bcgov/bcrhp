    ...
    <div
      ...
      <LabelledCheckboxInput label="This site does not have a Street Address"
        ...
        <Checkbox id="hasCivicAddress" ref="hasCivicAddress" :model-value="!currentCivicAddress.hasCivicAddress"
          aria-describedby="has-civic-address-help" aria-required="true" fluid binary small
      ...
      <FieldSet id="civicAddressFieldset" legend="Civic Address" :disabled="disableAddressSection">
        ...
        <LabelledInput label="Location Description"
          hint="Location description of the site if there is no street address" input-name="locationDescription"
          :error-message="errors.locationDescription?.join(',')" :required="true">
        ...
        <LabelledInput label="Locality (Optional)" hint="Established area or neighbourhood the site is located within"
