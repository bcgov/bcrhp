...
<template>
  <div class="flex flex-col h-48">
    ...
    <div
      ...
      <FieldSet id="siteBoundaryFieldSet" legend="Site Boundary" style="width: 45%; display: inline-block">
        <LabelledCheckboxInput label="Site Boundary icorrect" hint="Update the geometry" input-name="hasCivicAddress">
          <Checkbox id="boundaryIncorrect" ref="boundaryIncorrectField"
            :model-value="heritageSite.siteBoundaryIncorrect" aria-describedby="has-civic-address-help"
            aria-required="true" fluid binary small @change="hasAddressChanged" />
        </LabelledCheckboxInput>
        <LabelledInput label="Site Boundary" hint="Drag KML, GeoJSON or Shapefile here" input-name="authorizingAgency"
          :error-message="errors.streetAddress?.join(',')" :required="true">
          <div>
