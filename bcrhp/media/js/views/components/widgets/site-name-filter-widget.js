...
import nameFilterTemplate from 'templates/views/components/widgets/site-name-filter-widget.htm';

export default ko.components.register('site-name-filter-widget', {
    viewModel: function (params) {
        ...
        this.setNameVisible = function (widget) {
            ...
            var valueid = ko
                .unwrap(self.tile)
                .data[self.nameTypeWidget.node.nodeid]();
