...
import defaultSiteDescriptorsTemplate from 'templates/views/components/functions/bcrhp-site-descriptors.htm';

export default ko.components.register(
    'views/components/functions/bcrhp-site-descriptors',
    {
