...
const popupDataProvider = {
    layerConfigs: {
        ...
        'WHSE_TANTALIS.TA_CROWN_TENURES_SVW': {
            ...
            map_popup: [
                { key: 'TENURE_PURPOSE', title: 'Purpose: ' },
        ...
        'WHSE_LEGAL_ADMIN_BOUNDARIES.ABMS_LOCAL_TRUST_AREAS_SP': {
            ...
            map_popup: [
                ...
                {
                    key: 'ADMIN_AREA_GROUP_NAME',
                    title: 'Admin Area Group Name: ',
                },
            ],
        },
    },
    ...
    isFeatureClickable: function (feature, map) {
        ...
        if (
            (typeof selectedTool !== 'undefined' &&
                selectedTool !== null &&
                selectedTool !== 'filter_by_feature') ||
    ...
    getPopupTemplate: function (features) {
        const popupTemplate = _.some(features, function (feature) {
            return (
                feature.sourceLayer ===
                'WHSE_CADASTRE.PMBC_PARCEL_FABRIC_POLY_SVW'
            );
